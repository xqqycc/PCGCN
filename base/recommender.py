...
class Recommender(object):
    def __init__(self, conf, training_set_IF, test_set,training_set_IU,test_IF,test_IU, **kwargs):
        self.config = conf
        self.data = Data(self.config, training_set_IF, test_set,training_set_IU,test_IF,test_IU)
    ...
    def print_model_info(self):
        ...
        print('Training Set IF:', abspath(self.config['training_IF.set']))
        print('Training Set IU:', abspath(self.config['training_IF.set']))
